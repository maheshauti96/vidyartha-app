  ...
  return (
    <footer className="footer">
      <div className="footer-details">
        ...
        <div className="links">
          <a href={orgPath ? `/${orgPath}/returnpolicy` : "/returnpolicy"}>
            Return Policy
          </a>
          <a href={orgPath ? `/${orgPath}/terms` : "/terms"}>
            Terms and Conditions
          </a>
          <a href={orgPath ? `/${orgPath}/Shippingpolicy` : "/Shippingpolicy"}>
            Shipping Policy
          </a>
          <a href={orgPath ? `/${orgPath}/aboutus` : "/aboutus"}>About us</a>
          <a href={orgPath ? `/${orgPath}/privacypolicy` : "/privacypolicy"}>
            Privacy Policy
          </a>
        </div>
