  ...
  return (
    <footer className='footer'>
        <div className='footer-details'>
            ...
            <div className='links' >
                <a href={`${orgPath ? `/${orgPath}` : ''}/returnpolicy`}>Return Policy</a>
                <a href={`${orgPath ? `/${orgPath}` : ''}/terms`}>Terms and Conditions</a>
                <a href={`${orgPath ? `/${orgPath}` : ''}/Shippingpolicy`}>Shipping Policy</a>
                <a href={`${orgPath ? `/${orgPath}` : ''}/aboutus`}>About us</a>
                <a href={`${orgPath ? `/${orgPath}` : ''}/privacypolicy`}>Privacy Policy</a>
            </div>
